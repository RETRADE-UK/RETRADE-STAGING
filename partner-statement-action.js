...
(function(){
  ...
  function loadAdjustmentExporter(resolve,reject){
    ...
    var script=document.createElement('script');script.id='rt-partner-adjustment-statement-exporters';script.src='./partner-account-adjustment-statements.js?v=20260917-v1500';script.async=true;script.onload=function(){window.__rtPartnerAdjustmentStatementExportersReady?resolve():reject(new Error('Adjustment statement exporters did not initialise'));};script.onerror=reject;document.head.appendChild(script);
  }
  function loadAddon(resolve,reject){
    ...
    var addon=document.createElement('script');addon.id='rt-partner-statements-accounting-v3-script';addon.src='./partner-statements-accounting-v3.js?v=20260917-v1500';addon.async=true;addon.onload=function(){window.__rtPartnerStatementAccountingV3Ready?finish():reject(new Error('Statement accounting module did not initialise'));};addon.onerror=reject;document.head.appendChild(addon);
  }
