...
## Rollout reconciliation — v1.5.70

The MVP feature branch is reconciled onto the 24 September shared live fixes,
including tax/sales reconciliation, startup, sync feedback, FAB and navigation.
This rollout exposes the native monitor page in staging only. Its backend was
already deployed; no duplicate migrations or production database changes are
